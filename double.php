...
<ul>
		<li><img src="hotel-removebg-preview.png" style="width:60px"></li>
            ...
            <li><a href="double.php"class="active" style="background-color:#edbe6d;text-decoration: none;">Double Room</a></li>
...
<div class="col-md-3 book-form-left-w3layouts">
	...
	<div class="plans-section" id="rooms">
	 <div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Double Rooms</h3>
	  	<?php
        // Database connection
        $db_host = 'localhost';
        $db_user = 'root';
            ...
            //    echo'<h4 style="top: 3.3em;">'.$name.'</h4>';
               echo	'</div>';
					...
					// 				echo '</div>';
									...
									echo '<button style="background-color:#007bff;color:white;text-decoration:none;border:none"><a href="doublebookroom.php" style="background-color:#007bff;color:white;text-decoration:none;border:none">Book now</a></button>';	
							echo '</div>';
							echo '</div>';
							echo '</div>';
							echo '</div><br><br>';
