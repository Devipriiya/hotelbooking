...
<!-- header -->
		...
		<li><img src="hotel-removebg-preview.png" style="width:60px"></li>
			...
			<li><a href="luxury.php" class="active" style="background-color:#edbe6d;text-decoration: none;">Luxury Room</a></li>
            ...
            <li><a href="favourotes.php" style="text-decoration:none">Favorites</a></li>
...
<!-- //header -->
	...
	<div class="plans-section" id="rooms">
	 <div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Luxury Rooms</h3>
	  	<?php
        // Database connection
        $db_host = 'localhost';
        $db_user = 'root';
        ...
        if ($result->num_rows > 0) {
			...
			//    $name = $row['name'];
				...
				echo    '<img src="data:image/jpeg;base64,' . base64_encode($image_data) . '" alt="Image"style="width:100%;height:30%"/>';
            //    echo'<h4 style="top: 3.3em;">'.$name.'</h4>';
               echo	'</div>';
					echo '<div class="price-gd-bottom" style="    padding: -1.2em 0em 1em;" >';
					...
					echo '<button style="background-color:#007bff;color:white;text-decoration:none;border:none"><a href="bookroom.php" style="background-color:#007bff;color:white;text-decoration:none;border:none">Book now</a></button>';
                    echo '</div>';
							echo '</div>';
							echo '</div>';
							echo '</div><br><br>';
